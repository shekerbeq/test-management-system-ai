...
## Әлі кеңейтілетін талаптар

- OAuth2 Google толық login flow
- Refresh token
- Rate limiting және brute-force lockout
- Resilience4j circuit breaker және retry policy
- CSV/PDF export
- Token usage dashboard және audit log
- GitHub Actions CI/CD және Kubernetes manifests
